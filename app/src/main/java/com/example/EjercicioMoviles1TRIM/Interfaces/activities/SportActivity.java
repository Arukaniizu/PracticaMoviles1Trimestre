...
import com.example.EjercicioMoviles1TRIM.Interfaces.common.PoliAdapter;
...
public class SportActivity extends AppCompatActivity {
    ...
    private PoliAdapter mPoliAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getAllPoli();
        mListView = findViewById(R.id.listViewPoli);
    ...
    private void getAllPoli(){
        ...
        apiMadrid.getPisicnasList().enqueue(new Callback<JsonResponse>() {
            ...
            public void onResponse(Call<JsonResponse> call, Response<JsonResponse> response) {
                ...
                mPoliAdapter = new PoliAdapter(SportActivity.this, mLugarList);
                mListView.setAdapter(mPoliAdapter);
                mPoliAdapter.notifyDataSetChanged();
            }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == 1){
            Lugar lugar = (Lugar) mPoliAdapter.getItem(info.position);
            addFavorite(lugar);
    ...
    private void saveFavorites(ArrayList<Lugar> favorites){
        ...
        Toast.makeText(SportActivity.this, "Añadido a favoritos" , Toast.LENGTH_SHORT).show();
    }
