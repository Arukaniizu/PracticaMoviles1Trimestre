...
public class PiscinasAdapter extends BaseAdapter {
    private Context mContext;
    private List<Lugar> mLugarList;

    public PiscinasAdapter(Context mContext, List<Lugar> mLugarList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if(view == null){
            ...
            view = layoutInflater.inflate(R.layout.list_piscinas, null);
        }
        TextView mTextView = view.findViewById(R.id.txtPiscina);
